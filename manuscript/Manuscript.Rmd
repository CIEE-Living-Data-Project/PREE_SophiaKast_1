...
First, script to set up the project locally is provided. 

```{r create output directories if needed, echo=TRUE}
if( ! dir.exists("data") ){ dir.create("data") }
```

Next, I loaded the necessary libraries for this project. I used the groundhog package to do this for version control, but loaded the package `grateful` without groundhog as it is stored remotely.
